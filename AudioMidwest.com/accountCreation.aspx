<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accountCreation.aspx.cs" Inherits="AudioMidwest.com.accountCreation" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <%-- label column --%>
                <div class="col-sm-4 text-right">
                    <label class="col-form-label">Account Recovery Email</label>
                </div>

                <%-- user input column --%>
                <div class="col-sm-4">

                    <asp:TextBox ID="tboxAccountRecoveryEmail" class="form-control" runat="server"></asp:TextBox>

                    <small>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                            ErrorMessage="Please enter your email." ControlToValidate="tboxAccountRecoveryEmail"
                            ForeColor="Red" Display="Dynamic">
                        </asp:RequiredFieldValidator>

                        <%-- regex format email validator --%>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                            ErrorMessage="Please enter a valid email." ControlToValidate="tboxAccountRecoveryEmail"
                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"
                            ForeColor="Red">
                        </asp:RegularExpressionValidator>
                    </small>
                ...
                <div class="col-sm-4">
                    ...
                    <small>
                        <asp:RequiredFieldValidator ID="rfvStates" runat="server" ErrorMessage="Please select a state."
                            ControlToValidate="ddlStates" ForeColor="Red" InitialValue="0">
                        </asp:RequiredFieldValidator>
                    </small>
                ...
                <div class="col-sm-4">
                    ...
                    <small>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ErrorMessage="Please enter a zip code." ControlToValidate="tboxZip" ForeColor="Red"
                            Display="Dynamic">
                        </asp:RequiredFieldValidator>
